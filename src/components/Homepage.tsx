...
export default function Homepage({ onStartInstantScan, onRouteChange }: HomepageProps) {
  ...
  return (
    <div id="homepage-root" className="min-h-screen text-slate-100 selection:bg-blue-650 selection:bg-blue-600 selection:text-white relative">
      
      {/* 1. HERO SECTION WITH DEEP NAVY RAMP FRAME */}
      <section className="relative overflow-hidden pt-24 pb-28 border-b border-slate-700/80">
            ...
            >
              ...
              <div className="flex flex-col sm:flex-row space-y-4 sm:space-y-0 sm:space-x-4 pt-2">
                ...
                <motion.button
                  ...
                  className="px-8 py-4 bg-slate-900 border border-slate-700 text-slate-300 hover:text-white rounded-xl hover:bg-slate-800 transition-all flex items-center justify-center space-x-2 cursor-pointer text-sm font-semibold shadow-sm"
                >
              ...
              <div className="grid grid-cols-2 gap-4 border-t border-slate-800/80 pt-6 max-w-xl">
                <div className="flex items-center space-x-2.5 text-slate-400 text-[10px] font-mono font-bold tracking-wider">
            ...
            >
                ...
                <div className="space-y-4">
                  ...
                  <div>
                    ...
                    <input 
                      ...
                      className="w-full bg-slate-950/90 border border-white/10 rounded-lg px-3 py-1.5 text-sm text-white placeholder-slate-600 focus:outline-none focus:border-blue-500"
                    />
                  </div>
                  ...
                  <div className="bg-slate-950/90 p-3.5 rounded-xl border border-white/5 shadow-inner">
                    <div className="flex justify-between items-center pb-2 border-b border-white/5">
                      ...
                      <span className="text-lg font-display font-bold text-blue-400 font-mono">
                        {previewIntentScore} <span className="text-sm text-slate-400">/ 95</span>
                      </span>
                    </div>
                    
                    <div className="mt-2.5 space-y-1.5 text-[9px] font-mono">
                      <div className="flex justify-between">
                        <span className="text-slate-400">Area Compound Growth:</span>
                        <span className="text-slate-200 font-bold">+{previewProfile.growth}%</span>
                      </div>
                      <div className="flex justify-between">
                        <span className="text-slate-400">Permit Velocity Index:</span>
                        <span className="text-slate-200">{previewProfile.permitHeat} Units / 30</span>
                      </div>
                      <div className="flex justify-between">
                        <span className="text-slate-400">CPC Pricing Stress:</span>
                        <span className={`font-semibold ${cpcTier === 'High' ? 'text-orange-400' : 'text-blue-400'}`}>
                          {cpcTier} Cost Level
                        </span>
                      </div>
                      <div className="flex justify-between">
                        <span className="text-slate-400">Ad Competitor Density:</span>
                  ...
                  <motion.button 
                    ...
                    className="w-full py-3 bg-blue-600 font-display font-medium text-sm uppercase tracking-widest text-white hover:bg-blue-500 transition-all rounded-xl shadow-lg flex items-center justify-center space-x-2 border border-transparent hover:border-blue-400/50 cursor-pointer"
                  >
              ...
              <div className="grid grid-cols-2 gap-4 mt-4">
                ...
                <div className="bg-slate-900 border border-slate-800 rounded-xl p-4 shadow-lg text-slate-200 flex flex-col justify-between">
                  ...
                  <div>
                    <p className="text-sm font-bold text-white leading-tight">High Urgency Event Registered</p>
                ...
                <div className="bg-slate-900 border border-slate-800 rounded-xl p-4 shadow-lg text-slate-200 flex flex-col justify-between">
                  <div className="flex justify-between items-center border-b border-slate-800 pb-2 mb-2">
                    ...
                    <span className="text-sm font-mono font-bold text-blue-400 bg-blue-955/50 bg-blue-950/40 px-2 py-0.5 rounded border border-blue-900/30">$2,480</span>
                  </div>
                  <div className="mb-2">
                    <p className="text-sm font-bold text-white leading-snug">Broad Keyword Waste Prevented</p>
                  </div>
      ...
      <section className="bg-slate-900/50 text-slate-300 py-10 border-t border-b border-slate-800 backdrop-blur-md relative z-10 shadow-sm">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="grid grid-cols-2 md:grid-cols-4 gap-6 text-center">
            <div className="p-2 space-y-1">
              <p className="text-3xl sm:text-4xl font-display font-bold text-blue-400 tracking-tight">142,842</p>
              <p className="text-[9px] text-slate-400 font-mono font-bold tracking-widest uppercase">Live Ingestion Feeds</p>
            </div>
            <div className="p-2 space-y-1">
              <p className="text-3xl sm:text-4xl font-display font-bold text-slate-200 tracking-tight">418</p>
              <p className="text-[9px] text-slate-400 font-mono font-bold tracking-widest uppercase">NWS Alert Connections</p>
            </div>
            <div className="p-2 space-y-1">
              <p className="text-3xl sm:text-4xl font-display font-bold text-blue-400 tracking-tight">98.4%</p>
              <p className="text-[9px] text-slate-400 font-mono font-bold tracking-widest uppercase">Accuracy Validation</p>
            </div>
            <div className="p-2 space-y-1">
              <p className="text-3xl sm:text-4xl font-display font-bold text-orange-400 tracking-tight">$3.4K/mo</p>
      ...
      <section className="py-20 border-b border-slate-800/80 relative z-10">
          ...
          <div className="grid grid-cols-1 lg:grid-cols-12 gap-8 items-stretch">
            ...
            <div className="lg:col-span-6 bento-card p-6 sm:p-8 flex flex-col justify-between space-y-6 relative overflow-hidden">
              ...
              <div>
                <div className="flex items-center space-x-2.5 border-b border-slate-800 pb-4 mb-4">
                  ...
                  <div>
                    <h3 className="font-display font-medium text-slate-100 text-base">Corporate Growth & Profit Leverage Modeler</h3>
                    <p className="text-sm text-slate-400">Adjust parameters below to model exclusive climate lead yield</p>
                  </div>
                </div>
                ...
                <div className="space-y-5 text-sm">
                  {/* Select Trade Block */}
                  <div>
                    <span className="block text-slate-400 mb-1.5 font-mono text-sm font-bold tracking-wider uppercase">1. Select Target Trade Sector</span>
                    <div className="grid grid-cols-3 gap-2">
                      {['HVAC', 'Roofing', 'Plumbing'].map((tType) => (
                        <button
                          ...
                          className={`py-2 px-2.5 rounded-lg border text-center font-mono font-bold text-sm transition-all cursor-pointer ${
                            calcIndustry === tType 
                  ...
                  <div>
                    <div className="flex justify-between items-center mb-1.5 text-sm">
                      <span className="text-slate-400 font-mono font-bold tracking-wider uppercase">2. Average Ticket Value (ACV)</span>
                      <span className="font-mono font-extrabold text-blue-400 bg-blue-950/40 border border-blue-900/30 px-2.5 py-0.5 rounded text-sm">${calcJobValue.toLocaleString()} per job</span>
                    </div>
                    <input 
                      type="range" 
                  ...
                  <div>
                    <div className="flex justify-between items-center mb-1.5 text-sm">
                      <span className="text-slate-400 font-mono font-bold tracking-wider uppercase">3. Converted Exclusive Jobs / Month</span>
                      <span className="font-mono font-extrabold text-orange-400 bg-orange-950/40 border border-orange-900/30 px-2.5 py-0.5 rounded text-sm">{calcMonthlyJobs} Confirmed Deals</span>
                    </div>
                    <input 
                      type="range" 
                      min="1" 
                  ...
                  <div>
                    <div className="flex justify-between items-center mb-1.5 text-sm">
                      ...
                      <span className="font-mono font-extrabold text-teal-300 bg-slate-950 border border-white/10 px-2.5 py-0.5 rounded text-sm">${calcAdBudget.toLocaleString()} / mo</span>
                    </div>
                    <input 
                      type="range" 
                      min="100" 
            ...
            <div className="lg:col-span-6 flex flex-col justify-between space-y-6">
              ...
              <div className="bento-card p-6 space-y-4 flex-grow flex flex-col justify-between">
                <div>
                  <h3 className="text-sm font-mono font-bold text-blue-400 uppercase tracking-widest mb-2">Architectural Comparison</h3>
                ...
                <div className="grid grid-cols-1 sm:grid-cols-2 gap-4 text-sm font-sans mt-3">
                  {/* The Old Wasteful Way */}
                  <div className="p-4 bg-red-950/20 rounded-xl border border-red-500/10 space-y-3">
                    <div className="flex items-center justify-between text-red-500 font-bold font-mono text-[10px]">
                      <span>TRADITIONAL SHARED AGENCIES</span>
                      <span className="text-[9px] bg-red-950 text-red-400 px-1.5 py-0.5 rounded border border-red-500/20">WASTEFUL</span>
                    </div>
                    <ul className="space-y-2 text-slate-400 leading-normal text-[11px]">
                  ...
                  <div className="p-4 bg-emerald-950/20 border border-emerald-500/10 rounded-xl space-y-3 relative shadow-inner overflow-hidden">
                    <div className="absolute -top-6 -right-6 w-12 h-12 bg-emerald-500/5 rounded-full blur-lg" />
                    <div className="flex items-center justify-between text-emerald-500 font-bold font-mono text-[10px]">
                      <span>THE EXCLUSIVE JOBLEAK METRIC</span>
                      <span className="text-[9px] bg-emerald-950 text-emerald-400 px-1.5 py-0.5 rounded border border-emerald-500/20 font-bold whitespace-nowrap">100% EXCLUSIVE</span>
                    </div>
                    <ul className="space-y-2 text-slate-300 leading-normal text-[11px]">
                      <li className="flex items-start space-x-1.5">
              ...
              <div className="bento-card p-6 space-y-4">
                <h3 className="text-sm font-mono font-bold text-blue-400 uppercase tracking-widest">How We Work</h3>
                <h4 className="text-base font-display font-semibold text-white">
                  ...
                  <div className="space-y-1">
                    <b className="font-mono text-blue-400 block font-black text-sm">01 // TRACK METRIC SPIKES</b>
                    <p className="text-slate-400 text-[11px] leading-relaxed">We continuously poll public Open-Meteo & National Weather Service parameters for temperature strain and wind shifts.</p>
                  </div>
                  <div className="space-y-1">
                    <b className="font-mono text-indigo-400 block font-black text-sm">02 // SCORE THE DEMAND</b>
                    <p className="text-slate-400 text-[11px] leading-relaxed">Our system isolates emergency buyers from home DIY-ers, checking localized cost-per-click CPC pressure indices.</p>
                  </div>
                  <div className="space-y-1">
                    <b className="font-mono text-sky-400 block font-black text-sm">03 // INJECT OUTBOUND</b>
                    <p className="text-slate-400 text-[11px] leading-relaxed">You instantly copy pre-scraped, highest-efficiency keywords & outbound sms blocks to absorb immediate customer flow.</p>
                  </div>
                </div>
              </div>
      ...
      <section className="py-20 relative z-10" id="demo-interactive-previewer">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center max-w-3xl mx-auto mb-14 space-y-3">
            <h2 className="text-sm font-mono font-bold tracking-widest text-blue-600 uppercase">
              No Cold Starts
            </h2>
            <h3 className="text-3xl sm:text-4xl font-display font-medium tracking-tight text-white">
              Execute Pre-Calculated Sample Scans
            </h3>
            <p className="text-slate-655 text-slate-300 text-sm leading-relaxed font-sans">
            ...
            {[
              ...
              >
                <div>
                  ...
                  <h4 className="text-lg font-display font-semibold text-white group-hover:text-blue-600 transition-colors">
                    {sample.city}
                  </h4>
                  
                  <p className="text-sm text-slate-300 mt-2 leading-relaxed line-clamp-2 italic font-bold">
                    "{sample.svc}"
                  </p>
                </div>

                <div className="mt-4 flex items-center text-[10px] font-mono font-bold text-blue-600 group-hover:text-blue-700 pt-3 border-t border-slate-250 border-slate-205 border-slate-700/80 transition-colors">
      ...
      <section className="py-20 border-t border-b border-slate-700/80 relative z-10">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            ...
            >
              <div className="absolute -top-4 left-6 bg-blue-600 text-white w-8 h-8 rounded-lg flex items-center justify-center font-mono font-bold text-sm shadow-lg">
                01
              </div>
              ...
              <h4 className="text-lg font-display font-semibold text-white">Detect Signal Spikes</h4>
            ...
            >
              ...
              <h4 className="text-lg font-display font-semibold text-white">Prioritize Channels</h4>
              <p className="text-slate-300 text-sm leading-relaxed mt-3 font-semibold">
            ...
            >
              ...
              <h4 className="text-lg font-display font-semibold text-white">Win Urgent Business</h4>
              <p className="text-slate-300 text-sm leading-relaxed mt-3 font-semibold">
      ...
      <section className="py-20 relative z-10">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center max-w-3xl mx-auto mb-14 space-y-2">
            ...
            <p className="text-slate-655 text-slate-300 text-sm mt-3 leading-relaxed">
            ...
            {industriesList.map((ind, i) => (
              ...
              >
                <div>
                  ...
                  <h4 className="text-lg font-display font-semibold text-white">{ind.name}</h4>
                  <p className="text-sm text-slate-300 mt-2 leading-relaxed">{ind.description}</p>
                </div>
                
                <div className="mt-5 pt-4 border-t border-slate-700/80 flex items-center justify-between text-sm font-mono">
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
          <div className="grid grid-cols-1 lg:grid-cols-12 gap-12 items-center">
            ...
            <div className="lg:col-span-5 space-y-5">
              <h3 className="text-sm font-mono font-bold tracking-widest text-blue-600 uppercase">
                Diagnostic Pipeline Overview
              </h3>
              <h4 className="text-3xl font-display font-medium text-white tracking-tight leading-tighter">
              ...
              <div className="space-y-3 pt-2">
                <div className="flex items-start space-x-3 bg-slate-900 border border-slate-700 p-3.5 rounded-xl shadow-sm">
                  ...
                  <div className="space-y-0.5">
                    <h5 className="font-display font-semibold text-sm text-white">Geolocations & Weather forecasts</h5>
                    <p className="text-[11px] text-slate-300">Queries real-time Open-Meteo REST service endpoints on demand, matching historical thresholds instantly.</p>
                  </div>
                </div>
                ...
                <div className="flex items-start space-x-3 bg-slate-900 border border-slate-700 p-3.5 rounded-xl shadow-sm">
                  ...
                  <div className="space-y-0.5">
                    <h5 className="font-display font-semibold text-sm text-white">NWS Direct Active Hazards</h5>
                    <p className="text-[11px] text-slate-300">Polls active storms, wildfires, hard freeze forecasts, and tornado radar directly from official weather.gov coordinates.</p>
                  </div>
                </div>
                ...
                <div className="flex items-start space-x-3 bg-slate-900 border border-slate-700 p-3.5 rounded-xl shadow-sm">
                  ...
                  <div className="space-y-0.5">
                    <h5 className="font-display font-semibold text-sm text-white">SAM.gov Federal Contracting Bid Opportunities</h5>
                    <p className="text-[11px] text-slate-300">Activate via user secrets configuration to fetch bidding opportunities on local schools and buildings.</p>
                  </div>
                </div>
              </div>
            </div>
            ...
            <div className="lg:col-span-7 bg-slate-900 p-6 sm:p-8 rounded-2xl border border-slate-700 shadow-sm relative">
              ...
              <div className="space-y-6 relative">
                <div className="absolute top-8 bottom-8 left-4 border-l border-slate-700/80 border-dashed" />
                
                {/* Node 1 */}
                <div className="flex items-start space-x-4 relative">
                  <div className="h-8 w-8 rounded-full bg-blue-50 border border-blue-205 border-blue-200 flex items-center justify-center text-blue-600 font-mono font-bold text-sm ring-4 ring-white mt-0.5">
                    01
                  </div>
                  <div>
                    <h6 className="font-display text-sm text-white font-bold">API Ingestion Scrape (Meteo + geocoding)</h6>
                    <p className="text-[11px] text-slate-300 mt-1 font-semibold">Decodes city names to coordinates, queries temperature max/min, rain sum, and relative humidity matrices.</p>
                  </div>
                </div>

                {/* Node 2 */}
                <div className="flex items-start space-x-4 relative">
                  <div className="h-8 w-8 rounded-full bg-indigo-50 border border-indigo-200 flex items-center justify-center text-indigo-600 font-mono font-bold text-sm ring-4 ring-white mt-0.5">
                    02
                  </div>
                  <div>
                    <h6 className="font-display text-sm text-white font-bold">Algorithmic Math Evaluation Matrix</h6>
                    <p className="text-[11px] text-slate-300 mt-1 font-semibold">Cross-references variables against the 6 industry thresholds to isolate active damage markers.</p>
                  </div>
                </div>

                {/* Node 3 */}
                <div className="flex items-start space-x-4 relative">
                  <div className="h-8 w-8 rounded-full bg-sky-50 border border-sky-200 flex items-center justify-center text-blue-750 text-blue-700 font-mono font-bold text-sm ring-4 ring-white mt-0.5">
                    03
                  </div>
                  <div>
                    <h6 className="font-display text-sm text-white font-bold">Targeted Playbook Pack Generation</h6>
                    <p className="text-[11px] text-slate-300 mt-1 font-semibold">Outputs precision Broad Match arrays, exclusion keywords, radius limits, and customer outreach text blueprints.</p>
                  </div>
                </div>
              </div>
              ...
              <div className="mt-8 pt-6 border-t border-slate-700/80 text-center">
                <motion.button
                  ...
                  className="px-6 py-3 bg-blue-600 hover:bg-blue-500 shadow-xl transition-all rounded-xl font-display text-sm tracking-wider uppercase font-bold cursor-pointer text-white"
                >
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="grid grid-cols-1 lg:grid-cols-12 gap-12 items-center">
              ...
              <div className="bento-card p-6 font-mono text-[11px] space-y-4">
                <div className="flex items-center justify-between border-b border-slate-700 pb-3">
                  <div className="flex items-center space-x-2">
                    ...
                    <span className="font-bold tracking-wider uppercase text-slate-100 text-[10px]">SMS OUTBOUND PLAYBOOK PREVIEW</span>
                  </div>
                ...
                <div className="bg-slate-950 text-slate-200 p-4 rounded-xl border border-slate-800 font-sans leading-relaxed text-sm">
                ...
                <div className="space-y-1.5 text-sm text-slate-300 font-sans pt-1">
                  <div className="flex items-center space-x-2">
            ...
            <div className="lg:col-span-6 space-y-6">
              <h4 className="text-sm font-mono font-bold text-blue-600 uppercase tracking-widest">Scientific Content Engine</h4>
              <h5 className="text-3xl font-display font-medium text-white tracking-tight leading-tighter">
              ...
              <motion.button
                ...
                className="px-6 py-3 bg-slate-900 border border-slate-950 text-white font-display text-sm font-bold uppercase tracking-wider hover:bg-slate-850 rounded-xl inline-flex items-center space-x-2 shadow-md cursor-pointer"
              >
      ...
      <section className="py-20 border-t border-b border-slate-700/80 bg-slate-900/50/50 relative z-10">
        <div className="absolute top-[10%] right-[5%] w-[400px] h-[400px] rounded-full blue-glow-blob pointer-events-none opacity-20 z-0" />
        
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
          <div className="text-center max-w-3xl mx-auto mb-16 space-y-4">
            <span className="inline-flex items-center px-3 py-1 rounded-full text-sm font-mono font-bold uppercase tracking-wider bg-blue-50 text-blue-700 border border-blue-200">
              <ShieldCheck className="h-3 w-3 mr-1.5 text-blue-600" /> Member Network Integrity
            </span>
            <span className="block text-sm font-mono font-bold tracking-widest text-slate-400 uppercase">National Operational Scale</span>
            <h2 className="text-3xl sm:text-4xl font-display font-semibold tracking-tight text-white">
              Trusted by 4,820+ Active Trade Members
            </h2>
            <p className="text-slate-655 text-slate-300 text-sm leading-relaxed max-w-2xl mx-auto">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8 mb-16">
            ...
            {/* Metric 1 */}
            <div className="bento-card p-8 bg-slate-900 border border-slate-700 shadow-sm flex flex-col justify-between relative overflow-hidden group">
              ...
              <div className="space-y-4">
                ...
                <div>
                  ...
                  <p className="text-4xl font-display font-extrabold text-white tracking-tight mt-1">97.4%</p>
                </div>
            ...
            <div className="bento-card p-8 bg-slate-900 border border-slate-700 shadow-sm flex flex-col justify-between relative overflow-hidden group">
              ...
              <div className="space-y-4">
                ...
                <div>
                  ...
                  <p className="text-4xl font-display font-extrabold text-white tracking-tight mt-1">$3.4K<span className="text-base text-slate-400 font-normal">/mo avg</span></p>
                </div>
                <p className="text-sm text-slate-300 leading-relaxed font-sans font-medium">
            ...
            <div className="bento-card p-8 bg-slate-900 border border-slate-700 shadow-sm flex flex-col justify-between relative overflow-hidden group">
              ...
              <div className="space-y-4">
                ...
                <div>
                  ...
                  <p className="text-4xl font-display font-extrabold text-white tracking-tight mt-1">100%</p>
                </div>
                <p className="text-sm text-slate-300 leading-relaxed font-sans font-medium">
          ...
          <div className="bg-slate-900 border border-slate-700 rounded-2xl p-6 sm:p-8 shadow-sm">
            <div className="flex flex-col sm:flex-row items-start sm:items-center justify-between mb-8 pb-4 border-b border-slate-100">
              <div>
                <h3 className="font-display font-semibold text-white text-lg">National Member distribution</h3>
                <p className="text-sm text-slate-400">Active subscriber volume segmented across verified service trade sectors</p>
              </div>
              <span className="mt-2 sm:mt-0 px-3 py-1 bg-blue-50 text-blue-700 text-sm font-mono font-bold rounded-lg border border-blue-200">
                Updated Live
              </span>
            </div>
            ...
            <div className="grid grid-cols-2 lg:grid-cols-4 gap-6">
              {[
                ...
                <div key={tIdx} className="space-y-2 p-4 bg-slate-900/50 rounded-xl border border-slate-700">
                  <div className="flex justify-between items-baseline">
                    <span className="text-[10px] text-slate-400 font-mono font-bold block truncate">{trade.label}</span>
                    <span className="text-[9px] text-slate-400 font-mono font-bold">{trade.share}</span>
                  </div>
                  <p className="text-lg font-display font-black text-white tracking-tight">{trade.count}</p>
            ...
            <div className="mt-8 pt-6 border-t border-slate-100 flex flex-col sm:flex-row items-center justify-between text-sm text-slate-400 gap-4">
      ...
      <section className="bg-slate-900/50 text-slate-200 py-12 border-t border-slate-700 text-center relative z-10">
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 space-y-4">
          <p className="text-sm tracking-tight text-white font-bold flex items-center justify-center space-x-1.5">
            <ShieldCheck className="h-4 w-4 text-emerald-600" />
            <span>Platform Integrity • Strictly Legitimate Public & Geolocation Feeds Only</span>
          </p>
          <p className="text-sm leading-relaxed max-w-2xl mx-auto text-slate-400 font-mono">
