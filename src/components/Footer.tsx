...
export default function Footer({ onRouteChange }: FooterProps) {
  ...
  return (
    <footer id="app-footer" className="bg-slate-100 border-t border-slate-200 text-slate-500 text-xs py-12">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          ...
          <div className="space-y-4 md:col-span-1">
            <div className="flex items-center space-x-2">
              ...
              <span className="text-sm font-display font-bold text-slate-800 tracking-tight">
          ...
          {/* Quick links */}
          <div>
            <h4 className="text-slate-850 text-slate-800 font-semibold text-sm mb-4">Core Platform</h4>
            <ul className="space-y-2 font-mono text-[11px] uppercase tracking-wider text-slate-600">
              <li>
          ...
          <div>
            <h4 className="text-slate-850 text-slate-800 font-semibold text-sm mb-4">API Frameworks</h4>
            <ul className="space-y-2 font-sans">
              <li className="flex items-center space-x-2 text-[11px] text-slate-600">
              ...
              <li className="flex items-center space-x-2 text-[11px] text-slate-700">
          ...
          <div className="space-y-4">
            <h4 className="text-slate-850 text-slate-800 font-semibold text-sm mb-4">Network Status</h4>
            <div className="p-3 bg-white rounded-lg border border-slate-205 border-slate-200 shadow-sm space-y-1">
            ...
            <div className="pt-2 text-right">
              <button 
                ...
                className="text-[9px] font-mono text-slate-400 hover:text-slate-600 underline transition-colors"
              >
        ...
        <div className="mt-8 pt-6 border-t border-slate-200 flex flex-col sm:flex-row justify-between items-center space-y-4 sm:space-y-0 text-[11px] font-sans">
