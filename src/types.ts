...
export const StatesList: StateDetails[] = [
  { code: 'TX', name: 'Texas', cities: ['Austin', 'Dallas', 'Houston', 'San Antonio', 'Fort Worth'] },
  { code: 'AZ', name: 'Arizona', cities: ['Phoenix', 'Tucson', 'Mesa', 'Chandler'] },
  { code: 'FL', name: 'Florida', cities: ['Tampa', 'Orlando', 'Miami', 'Jacksonville', 'Miami'] },
  ...
  { code: 'IL', name: 'Illinois', cities: ['Chicago', 'Aurora', 'Naperville', 'Joliet'] },
  ...
  { code: 'VA', name: 'Virginia', cities: ['Virginia Beach', 'Chesapeake', 'Norfolk', 'Arlington'] },
  ...
  { code: 'MD', name: 'Maryland', cities: ['Baltimore', 'Columbia', 'Germantown', 'Silver Spring'] },
  ...
  { code: 'LA', name: 'Louisiana', cities: ['New Orleans', 'Baton Rouge', 'Shreveport', 'Metairie'] },
  ...
  { code: 'KS', name: 'Kansas', cities: ['Wichita', 'Overland Park', 'Kansas City', 'Olathe'] },
  ...
  { code: 'HI', name: 'Hawaii', cities: ['Honolulu', 'East Honolulu', 'Pearl City', 'Hilo'] },
